  ...
  return (
    <div className="card">
      <h3 style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '1.5rem', display: 'flex', alignItems: 'center' }}>
        <span style={{ width: '0.5rem', height: '2rem', backgroundColor: '#c084fc', borderRadius: '1rem', marginRight: '1rem' }}></span>
      ...
      <form onSubmit={onUpdate}>
        ...
        <button type="submit" disabled={saving} className="btn-save" style={{ backgroundColor: '#9333ea' }}>
